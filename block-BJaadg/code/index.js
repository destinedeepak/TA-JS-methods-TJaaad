...
*/
console.log(`Does from, to and quote ends with "rk". Check all three.???`)
...
*/
let quoteIn70Chars = quote.padEnd(70,".")
/*
16. Do same as (15) but the ... should come in start. Store the output in a new variable
*/
let quoteIn70Chars2 = quote.padStart(70,".")
/*
